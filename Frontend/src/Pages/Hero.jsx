        ...
        <section class=" bg-[#d6d2d2a6] m-2 h-96">
          <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            <div class="mr-auto place-self-center lg:col-span-7">
              ...
              <Link
                to=""
                class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 bg-amber-600"
              >
                View More
              </Link>
            </div>
      ...
      <SwiperSlide>
        <section class=" bg-[#d6d2d2a6] m-2">
          <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex h-full">
              <img
                src="https://ik.imagekit.io/4sjmoqtje/tr:w-1480,c-at_max/cdn/shop/files/3-slider-banner-india-mens-desktop-2800x1050-27-3-25.jpg?v=1743508913"
                alt="mockup"
                className=" h-full cursor-pointer"
              />
            </div>
